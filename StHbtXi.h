...
class StHbtXi : public StHbtV0 {
 ...
 public:
  ...
  StHbtXi();
  /// Copy constructor
  StHbtXi(const StHbtXi& copy);
  /// Copy constructor
  StHbtXi& operator=(const StHbtXi& copy);
  /// Default destructor
  ~StHbtXi();
  ...
  StHbtTrack *bachelor() const       { return (mBachelor) ? mBachelor : nullptr; }
  ...
  void setBachelor(const StHbtTrack& bachelor);
